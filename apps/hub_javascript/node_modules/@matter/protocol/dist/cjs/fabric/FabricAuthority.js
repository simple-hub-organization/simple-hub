...
class FabricAuthority {
  ...
  async createFabric() {
    ...
    const fabricBuilder = new import_Fabric.FabricBuilder().setRootCert(this.#ca.rootCert).setRootNodeId(rootNodeId).setIdentityProtectionKey(ipkValue).setRootVendorId(this.#config.adminVendorId ?? DEFAULT_ADMIN_VENDOR_ID);

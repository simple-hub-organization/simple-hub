...
class Fabric {
  ...
  verifyCredentials(operationalCert, intermediateCACert) {
    if (intermediateCACert === void 0) {
      import_CertificateManager.CertificateManager.verifyNodeOperationalCertificate(
        import_CertificateManager.TlvRootCertificate.decode(this.rootCert),
        import_CertificateManager.TlvOperationalCertificate.decode(operationalCert)
      );
    } else {
      const decodedIcaCert = import_CertificateManager.TlvIntermediateCertificate.decode(intermediateCACert);
      import_CertificateManager.CertificateManager.verifyNodeOperationalCertificate(
        decodedIcaCert,
        import_CertificateManager.TlvOperationalCertificate.decode(operationalCert)
      );
      import_CertificateManager.CertificateManager.verifyIntermediateCaCertificate(
        import_CertificateManager.TlvRootCertificate.decode(this.rootCert),
        decodedIcaCert
      );
    }
...
class FabricBuilder {
  ...
  setOperationalCert(operationalCert, intermediateCACert) {
    ...
    if (intermediateCACert !== void 0) {
      const decodedIntermediateCACert = import_CertificateManager.TlvIntermediateCertificate.decode(intermediateCACert);
      import_CertificateManager.CertificateManager.verifyIntermediateCaCertificate(
        import_CertificateManager.TlvRootCertificate.decode(this.#rootCert),

...
class PaseServerMessenger extends import_SecureChannelMessenger.SecureChannelMessenger {
  ...
  readPasePake1() {
    return this.nextMessageDecoded(import_types.SecureMessageType.PasePake1, import_PaseMessages.TlvPasePake1, "PASE Pake1");
  }
  ...
  readPasePake3() {
    return this.nextMessageDecoded(import_types.SecureMessageType.PasePake3, import_PaseMessages.TlvPasePake3, "PASE Pake3");
  }
}
class PaseClientMessenger extends import_SecureChannelMessenger.SecureChannelMessenger {
  ...
  readPasePake2() {
    return this.nextMessageDecoded(import_types.SecureMessageType.PasePake2, import_PaseMessages.TlvPasePake2, "PASE Pake2");
  }

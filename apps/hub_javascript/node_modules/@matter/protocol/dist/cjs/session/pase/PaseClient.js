...
class PaseClient {
  ...
  async pair(sessionParameters, exchange, setupPin) {
    ...
    if (pbkdfParameters === void 0)
      throw new import_general.UnexpectedDataError("Missing requested PbkdfParameters in the response.");
    sessionParameters = {
    ...
    if (!import_general.Bytes.areEqual(verifier, hBX))
      throw new import_general.UnexpectedDataError("Received incorrect key confirmation from the receiver.");

...
class DeviceCommissioner {
  ...
  async endCommissioning() {
    ...
    if (this.#windowStatus === import_administrator_commissioning.AdministratorCommissioning.CommissioningWindowStatus.EnhancedWindowOpen || this.#context.fabrics.length > 0) {

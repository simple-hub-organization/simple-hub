    ...
    await this.#mdnsServer.setRecordsGenerator(announcedNetPort, import_MdnsServer.AnnouncementType.Operative, async (netInterface) => {
      ...
      fabrics.forEach((fabric) => {
        ...
        logger.debug(
          ...
          import_general.Diagnostic.dict({
            id: `${import_general.Bytes.toHex(operationalId)}/${nodeId}`,
        ...
        const fabricRecords = [
          ...
          (0, import_general.PtrRecord)(import_MdnsConsts.MATTER_SERVICE_QNAME, deviceMatterQname),
          (0, import_general.PtrRecord)(fabricQname, deviceMatterQname),
          (0, import_general.SrvRecord)(deviceMatterQname, { priority: 0, weight: 0, port: announcedNetPort, target: hostname }),
          (0, import_general.TxtRecord)(deviceMatterQname, [
            `SII=${sessionIdleInterval}`,
            `SAI=${sessionActiveInterval}`,
            `SAT=${sessionActiveThreshold}`
            //`T=${TCP_SUPPORTED}` /* TCP not supported */,

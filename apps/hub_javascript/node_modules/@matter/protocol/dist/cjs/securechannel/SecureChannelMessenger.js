...
class SecureChannelMessenger {
   ...
   */
  async nextMessage(expectedMessageInfo, expectedMessageType, expectedProcessingTimeMs = this.#defaultExpectedProcessingTimeMs) {
   ...
   * When no expectedProcessingTimeMs is provided, the default value of EXPECTED_CRYPTO_PROCESSING_TIME_MS is used.
   */
  async nextMessageDecoded(expectedMessageType, schema, expectedMessageInfo, expectedProcessingTimeMs = this.#defaultExpectedProcessingTimeMs) {
  ...
  async waitForSuccess(expectedMessageInfo, expectedProcessingTimeMs = this.#defaultExpectedProcessingTimeMs) {
    await this.nextMessage(expectedMessageInfo, import_types.SecureMessageType.StatusReport, expectedProcessingTimeMs);
  }
  /**

 ...
 */
export declare const GroupKeyManagementBehavior: ClusterBehavior.Type<GroupKeyManagement.Cluster, ClusterBehavior.Type<import("@matter/types").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;

 ...
 */
export declare const GeneralDiagnosticsBehavior: ClusterBehavior.Type<GeneralDiagnostics.Cluster, ClusterBehavior.Type<import("@matter/types").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;

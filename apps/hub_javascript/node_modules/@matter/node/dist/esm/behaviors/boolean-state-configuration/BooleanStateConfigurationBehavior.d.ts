 ...
 */
export declare const BooleanStateConfigurationBehavior: ClusterBehavior.Type<BooleanStateConfiguration.Cluster, ClusterBehavior.Type<import("@matter/types").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;

...
declare const WindowCoveringServerBase: import("../../index.js").ClusterBehavior.Type<import("#types").ClusterComposer.WithFeatures<ClusterType.Of<{
    readonly id: 258;
...
}>, readonly [WindowCovering.Feature.Lift, WindowCovering.Feature.Tilt, WindowCovering.Feature.PositionAwareLift, WindowCovering.Feature.PositionAwareTilt, WindowCovering.Feature.AbsolutePosition]>, import("../../index.js").ClusterBehavior.Type<ClusterType.Of<{
    readonly id: 258;
    readonly name: "WindowCovering";
    readonly revision: 5;
    readonly features: {
 ...
 * implementation.
 */
export declare class WindowCoveringServerLogic extends WindowCoveringServerBase {
    #private;
    protected internal: WindowCoveringServerLogic.Internal;
    state: WindowCoveringServerLogic.State;
    initialize(): void;
    /**
     ...
     */
    goToLiftValue({ liftValue }: WindowCovering.GoToLiftValueRequest): void;
    /**
     ...
     */
    goToTiltValue({ tiltValue }: WindowCovering.GoToTiltValueRequest): void;
    /**
     * Move the WindowCovering to a specific tilt value. The method calls the handleMovement method to actually move the
     * device to the defined position.
     */
    goToTiltPercentage({ tiltPercent100thsValue }: WindowCovering.GoToTiltPercentageRequest): void;
}
export declare namespace WindowCoveringServerLogic {
    class Internal {
...
}>, typeof WindowCoveringServerLogic, import("./WindowCoveringInterface.js").WindowCoveringInterface>;

...
class GeneralCommissioningServer extends GeneralCommissioningBehavior {
  ...
  async armFailSafe({ breadcrumb, expiryLengthSeconds }) {
    ...
    try {
      if (!commissioner.isFailsafeArmed && this.agent.get(AdministratorCommissioningServer).state.windowStatus !== AdministratorCommissioning.CommissioningWindowStatus.WindowNotOpen && !this.session.isPase) {
      ...
      if (commissioner.isFailsafeArmed) {
        ...
        await commissioner.beginTimed(
          new ServerNodeFailsafeContext(this.endpoint, {

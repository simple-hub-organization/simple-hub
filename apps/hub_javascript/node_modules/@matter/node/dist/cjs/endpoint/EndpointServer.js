...
var import_ClusterServerBacking = require("#behavior/internal/ClusterServerBacking.js");
  ...
  createBacking(type) {
    ...
    if (type.prototype instanceof import_ClusterBehavior.ClusterBehavior) {
      ...
      if (this.#clusterServers.has(cluster.id)) {
        throw new import_general.InternalError(`${this.#endpoint}.${cluster.id} initialized multiple times`);
      }
      backing = new import_ClusterServerBacking.ClusterServerBacking(this, type);
    } else {
      backing = new import_ServerBehaviorBacking.ServerBehaviorBacking(this.#endpoint, type, this.#endpoint.behaviors.optionsFor(type));
    }
    return backing;
  }
  get number() {

...
__export(SwitchServer_exports, {
  ...
  SwitchServerLogic: () => SwitchServerLogic
});
...
class SwitchServerLogic extends SwitchServerBase {
  schema = schema;
  initialize() {
...
((SwitchServerLogic2) => {
  ...
  SwitchServerLogic2.Internal = Internal;
  ...
  SwitchServerLogic2.State = State;
  ...
  SwitchServerLogic2.Events = Events;
})(SwitchServerLogic || (SwitchServerLogic = {}));
class SwitchServer extends SwitchServerLogic.for((0, import_types.ClusterType)(import_switch.Switch.Base)) {
}

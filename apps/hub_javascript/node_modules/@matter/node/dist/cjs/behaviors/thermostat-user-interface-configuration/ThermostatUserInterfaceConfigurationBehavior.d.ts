 ...
 */
export declare const ThermostatUserInterfaceConfigurationBehavior: ClusterBehavior.Type<ThermostatUserInterfaceConfiguration.Cluster, typeof ClusterBehavior, {
    components: never[];
}>;

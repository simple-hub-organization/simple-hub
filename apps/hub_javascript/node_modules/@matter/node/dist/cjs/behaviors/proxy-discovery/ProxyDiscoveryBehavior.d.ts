 ...
 */
export declare const ProxyDiscoveryBehavior: ClusterBehavior.Type<ProxyDiscovery.Cluster, ClusterBehavior.Type<import("@matter/types").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
    ...
    readonly commands: {};
    readonly events: {};
}>, typeof ClusterBehavior, ProxyDiscoveryInterface>, ProxyDiscoveryInterface>;
...
export declare namespace ProxyDiscoveryBehavior {
    interface State extends StateType {
    }
}
export {};
//# sourceMappingURL=ProxyDiscoveryBehavior.d.ts.map
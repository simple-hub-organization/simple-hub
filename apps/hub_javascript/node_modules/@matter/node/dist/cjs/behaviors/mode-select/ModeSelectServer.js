...
__export(ModeSelectServer_exports, {
  ...
  ModeSelectServerLogic: () => ModeSelectServerLogic
});
...
const ModeSelectServerBase = import_ModeSelectBehavior.ModeSelectBehavior.with(import_mode_select.ModeSelect.Feature.OnOff);
class ModeSelectServerLogic extends ModeSelectServerBase {
  initialize() {
    ...
    if (this.features.onOff && this.state.onMode !== void 0 && this.state.onMode !== null) {
      ...
      if (onOffServer !== void 0) {
        if (onOffServer.features.lighting && onOffServer.state.startUpOnOff === import_on_off2.OnOff.StartUpOnOff.On) {
...
class ModeSelectServer extends ModeSelectServerLogic.for((0, import_types.ClusterType)(import_mode_select.ModeSelect.Base)) {
}

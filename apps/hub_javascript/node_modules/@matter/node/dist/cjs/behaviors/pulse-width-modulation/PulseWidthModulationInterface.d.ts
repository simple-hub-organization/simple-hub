...
export declare namespace PulseWidthModulationInterface {
    interface Base {
        /**
         * @see {@link MatterSpecification.v11.Cluster} § 1.6.6.1
         */
...
export type PulseWidthModulationInterface = {
    components: [
        {
            flags: {};
            methods: PulseWidthModulationInterface.Base;
        },
        {
            flags: {
                frequency: true;
            };
            methods: PulseWidthModulationInterface.Frequency;
        }
    ];
};
//# sourceMappingURL=PulseWidthModulationInterface.d.ts.map
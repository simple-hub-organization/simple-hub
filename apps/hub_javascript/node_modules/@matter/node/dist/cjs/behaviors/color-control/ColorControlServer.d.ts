...
declare const ColorControlServerBase: import("../../index.js").ClusterBehavior.Type<import("#types").ClusterComposer.WithFeatures<ColorControl.Cluster, readonly [ColorControl.Feature.HueSaturation, ColorControl.Feature.EnhancedHue, ColorControl.Feature.ColorLoop, ColorControl.Feature.Xy, ColorControl.Feature.ColorTemperature]>, import("../../index.js").ClusterBehavior.Type<ColorControl.Cluster, import("../../index.js").ClusterBehavior.Type<ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
    ...
    readonly commands: {};
    readonly events: {};
}>, typeof import("../../index.js").ClusterBehavior, import("./ColorControlInterface.js").ColorControlInterface>, import("./ColorControlInterface.js").ColorControlInterface>, import("./ColorControlInterface.js").ColorControlInterface>;
/**
 ...
 * data ranges.
 */
export declare class ColorControlServerLogic extends ColorControlServerBase {
    #private;
    protected internal: ColorControlServerLogic.Internal;
    state: ColorControlServerLogic.State;
     ...
     * increased or decreased by the step size every transition time interval.
     */
    colorLoopSet({ optionsMask, optionsOverride, updateFlags, action, direction, time, startHue, }: ColorControl.ColorLoopSetRequest): MaybePromise<void>;
    /**
     * Default implementation notes:
...
export declare namespace ColorControlServerLogic {
    class Internal {
            ...
            readonly commands: {
                readonly colorLoopSet: import("#types").Command<import("#types").TypeFromFields<{
                    updateFlags: import("#types").FieldType<TypeFromPartialBitSchema<{
                        ...
                        reserved: import("#types").BitField;
                    }>>;
                    action: import("#types").FieldType<ColorControl.Action>;
                    direction: import("#types").FieldType<ColorControl.ColorLoopSetDirection>;
...
}>, typeof ColorControlServerLogic, import("./ColorControlInterface.js").ColorControlInterface>;

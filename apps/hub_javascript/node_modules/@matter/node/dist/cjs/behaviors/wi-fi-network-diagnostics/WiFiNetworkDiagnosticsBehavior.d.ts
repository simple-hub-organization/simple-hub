 ...
 */
export declare const WiFiNetworkDiagnosticsBehavior: ClusterBehavior.Type<WiFiNetworkDiagnostics.Cluster, ClusterBehavior.Type<import("@matter/types").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;

 ...
 */
export declare const SoftwareDiagnosticsBehavior: ClusterBehavior.Type<SoftwareDiagnostics.Cluster, ClusterBehavior.Type<import("@matter/types").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;

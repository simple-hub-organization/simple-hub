...
var import_NodePeerStore = require("./NodePeerStore.js");
/**
 * @license
...
class ClientNodes extends import_EndpointContainer.EndpointContainer {
  ...
  constructor(owner) {
    ...
    this.owner.env.set(import_protocol.PeerAddressStore, new import_NodePeerStore.NodePeerStore(owner));
   ...
   */
  locate(options) {
    return new import_behavior.InstanceDiscovery(this.owner, options);
  }
  /**
   ...
   */
  discover(options) {
    return new import_behavior.ContinuousDiscovery(this.owner, options);
  }
  commission(optionsOrPasscode, discriminator) {
    ...
    return new import_behavior.CommissioningDiscovery(this.owner, optionsOrPasscode);
  }
  get(id) {
    if (typeof id !== "string") {

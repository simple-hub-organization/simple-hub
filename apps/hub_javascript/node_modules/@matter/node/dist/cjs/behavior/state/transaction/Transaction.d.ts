...
export declare const Transaction: {
     ...
     */
    ReadOnly: {
        "__#125789@#participants": Set<Participant>;
        "__#125789@#roles": Map<{}, Participant>;
        "__#125789@#resources": Set<Resource>;
        "__#125789@#status": Status;
        "__#125789@#waitingOn"?: Iterable<Transaction>;
        "__#125789@#via": string;
        "__#125789@#shared"?: import("#general").Observable<[]>;
        "__#125789@#closed"?: import("#general").Observable<[]>;
        close(): void;
        readonly via: string;
        readonly status: Status;
        readonly participants: Set<Participant>;
        ...
        waitFor(others: Set<Transaction>): Promise<void>;
        toString(): string;
        "__#125789@#finalize"(status: Status, why: string, finalizer: () => MaybePromise): Promise<void> | undefined;
        "__#125789@#executePreCommit"(): MaybePromise<void>;
        "__#125789@#executeCommit"(): MaybePromise;
        "__#125789@#executeCommit1"(): MaybePromise;
        "__#125789@#executeCommit2"(): Promise<void> | undefined;
        "__#125789@#executePostCommit"(participants: Participant[]): MaybePromise;
        "__#125789@#executeRollback"(): Promise<void> | undefined;
        "__#125789@#log"(...message: unknown[]): void;
        "__#125789@#locksChanged"(resources: Set<Resource>, how?: string): void;
        "__#125789@#assertAvailable"(): void;
    };

...
export declare abstract class Behavior {
     ...
     */
    get session(): import("@matter/protocol").SecureSession;
    /**
    ...
    get [Resource.reference](): import("./state/managed/Datasource.js").Datasource<import("./state/StateType.js").StateType>;
}

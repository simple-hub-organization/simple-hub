...
function astToFunction(schema, supervisor) {
  ...
  function createName(param) {
    if (featuresAvailable.has(param)) {
      ...
      param = (0, import_general.camelize)(param);
      return {
        code: import_conformance_util.Code.Evaluate,
  ...
  function requireValue(value, _session, location) {
    if (value === void 0) {
      throw new import_errors.ConformanceError(schema, location, "Matter requires you to set this attribute");
    }
  }
  function disallowValue(value, _session, location) {
    if (value !== void 0) {
      throw new import_errors.ConformanceError(schema, location, "Matter does not allow you to set this attribute");
    }
  }

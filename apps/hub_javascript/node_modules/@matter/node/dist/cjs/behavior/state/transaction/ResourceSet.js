 ...
 */
const logger = import_general.Logger.get("ResourceSet");
class ResourceSet {
  #transaction;
  ...
  acquireLocksSync() {
    ...
    if (blocked.size) {
      ...
      throw new import_Errors.SynchronousTransactionConflictError(`Cannot lock ${(0, import_general.describeList)("and", ...names)} synchronously`);
    }

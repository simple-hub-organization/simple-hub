...
var import_Tx = require("../../state/transaction/Tx.js");
...
const OfflineContext = {
  ...
  act(purpose, activity, actor, options) {
    ...
    try {
      ...
      const result = import_Transaction.Transaction.act(via, actOffline);
   ...
   */
  ReadOnly: createOfflineContext(import_Tx.ReadOnlyTransaction),

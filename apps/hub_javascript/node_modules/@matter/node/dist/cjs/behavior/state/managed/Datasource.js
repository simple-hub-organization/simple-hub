...
var import_Tx = require("../transaction/Tx.js");
/**
 * @license
  ...
  return {
    ...
    get view() {
      if (!readOnlyView) {
        const session = {
          offline: true,
          authorizedFor(desiredAccessLevel) {
            return desiredAccessLevel === import_model.AccessLevel.View;
          },
          transaction: import_Tx.ReadOnlyTransaction
        };
        readOnlyView = createSessionContext(this, internals, session).managed;
      }
      return readOnlyView;
    }
  };
...
function createSessionContext(resource, internals, session) {
  ...
  const reference = {
    ...
    get value() {
      if (expired) {
        throw new import_errors.ExpiredReferenceError(this.location);
      }
      return values;
    },
    set value(_value) {

...
export declare function assertBytes(value: Val, path: SchemaErrorPath): asserts value is Uint8Array;
export declare function assertSequence(value: Val, path: SchemaErrorPath): asserts value is string | Uint8Array;

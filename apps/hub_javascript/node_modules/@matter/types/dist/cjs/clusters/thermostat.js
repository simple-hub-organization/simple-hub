  ...
  Thermostat2.OccupancyComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
      ...
      occupancy: (0, import_Cluster.Attribute)(
        2,
        (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, import_occupancy_sensing.OccupancySensing.Occupancy),
        { default: (0, import_BitmapSchema.BitsFromPartial)(import_occupancy_sensing.OccupancySensing.Occupancy, { occupied: true }) }
      )
    }
  });

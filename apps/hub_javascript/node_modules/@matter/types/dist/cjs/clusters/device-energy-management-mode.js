...
((DeviceEnergyManagementMode2) => {
  ...
  DeviceEnergyManagementMode2.OnOffComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
      /**
  ...
  DeviceEnergyManagementMode2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      supportedModes: (0, import_Cluster.FixedAttribute)(0, (0, import_TlvArray.TlvArray)(DeviceEnergyManagementMode2.TlvModeOption, { minLength: 2, maxLength: 255 })),
      /**
     ...
     */
    extensions: import_MutableCluster.MutableCluster.Extensions({ flags: { onOff: true }, component: DeviceEnergyManagementMode2.OnOffComponent })
  });
  ...
  DeviceEnergyManagementMode2.CompleteInstance = (0, import_MutableCluster.MutableCluster)({
    ...
    attributes: {
      ...
      onMode: import_MutableCluster.MutableCluster.AsConditional(DeviceEnergyManagementMode2.OnOffComponent.attributes.onMode, { mandatoryIf: [DEPONOFF] })
    },

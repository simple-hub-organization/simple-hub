...
((DeviceEnergyManagement2) => {
  ...
  DeviceEnergyManagement2.TlvSlot = (0, import_TlvObject.TlvObject)({
    ...
    slotIsPauseable: (0, import_TlvObject.TlvOptionalField)(5, import_TlvBoolean.TlvBoolean),
    /**
  ...
  DeviceEnergyManagement2.TlvForecast = (0, import_TlvObject.TlvObject)({
     ...
     */
    forecastId: (0, import_TlvObject.TlvField)(0, import_TlvNumber.TlvUInt16),
    /**
     ...
     */
    isPauseable: (0, import_TlvObject.TlvField)(6, import_TlvBoolean.TlvBoolean),
    /**
  ...
  DeviceEnergyManagement2.TlvSlotAdjustment = (0, import_TlvObject.TlvObject)({
     ...
     */
    nominalPower: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvInt64),
    /**
  ...
  DeviceEnergyManagement2.TlvConstraints = (0, import_TlvObject.TlvObject)({
     ...
     */
    duration: (0, import_TlvObject.TlvField)(1, import_TlvNumber.TlvUInt32.bound({ min: 0, max: 86400 })),
    /**
  ...
  DeviceEnergyManagement2.PowerAdjustmentComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      powerAdjustmentCapability: (0, import_Cluster.Attribute)(
        5,
        (0, import_TlvNullable.TlvNullable)((0, import_TlvArray.TlvArray)(DeviceEnergyManagement2.TlvPowerAdjust, { maxLength: 8 })),
        { default: null }
      )
    },
    commands: {

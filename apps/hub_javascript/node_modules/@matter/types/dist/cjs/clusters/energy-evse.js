...
((EnergyEvse2) => {
  ...
  EnergyEvse2.TlvChargingTargetSchedule = (0, import_TlvObject.TlvObject)({
    dayOfWeekForSequence: (0, import_TlvObject.TlvOptionalField)(0, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, EnergyEvse2.TargetDayOfWeek)),
    chargingTargets: (0, import_TlvObject.TlvOptionalField)(1, (0, import_TlvArray.TlvArray)(EnergyEvse2.TlvChargingTarget, { maxLength: 10 }))
  });
  ...
  EnergyEvse2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
      ...
      randomizationDelayWindow: (0, import_Cluster.OptionalWritableAttribute)(
        10,
        import_TlvNumber.TlvUInt32.bound({ min: 0, max: 86400 }),

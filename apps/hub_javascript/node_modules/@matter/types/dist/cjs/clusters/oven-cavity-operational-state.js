...
((OvenCavityOperationalState2) => {
  OvenCavityOperationalState2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    ...
    commands: {
       ...
       */
      pause: (0, import_Cluster.OptionalCommand)(0, import_TlvNoArguments.TlvNoArguments, 0, import_Cluster.TlvNoResponse),
      /**
       ...
       */
      stop: (0, import_Cluster.OptionalCommand)(1, import_TlvNoArguments.TlvNoArguments, 1, import_Cluster.TlvNoResponse),
      /**
       ...
       */
      start: (0, import_Cluster.OptionalCommand)(2, import_TlvNoArguments.TlvNoArguments, 2, import_Cluster.TlvNoResponse),
      /**
       ...
       */
      resume: (0, import_Cluster.OptionalCommand)(3, import_TlvNoArguments.TlvNoArguments, 3, import_Cluster.TlvNoResponse)
    },
    events: {
      /**

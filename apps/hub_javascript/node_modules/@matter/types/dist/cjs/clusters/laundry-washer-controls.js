...
((LaundryWasherControls2) => {
  ...
  LaundryWasherControls2.ClusterInstance = (0, import_MutableCluster.MutableCluster)(LaundryWasherControls2.Base);
  ...
  LaundryWasherControls2.CompleteInstance = (0, import_MutableCluster.MutableCluster)({
    id: LaundryWasherControls2.Cluster.id,
    name: LaundryWasherControls2.Cluster.name,
    revision: LaundryWasherControls2.Cluster.revision,
    features: LaundryWasherControls2.Cluster.features,
    attributes: {

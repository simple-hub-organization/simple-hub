...
export declare function GroupId(groupId: number | bigint, validate?: boolean): GroupId;
export declare namespace GroupId {
    const UNSPECIFIED_GROUP_ID: GroupId;
    const isValid: (groupId: number | bigint, validate?: boolean | undefined) => boolean;
}

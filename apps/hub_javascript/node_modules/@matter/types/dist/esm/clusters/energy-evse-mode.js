...
((EnergyEvseMode2) => {
  ...
  EnergyEvseMode2.Base = MutableCluster.Component({
     ...
     * combinations.
     */
    extensions: MutableCluster.Extensions({ flags: { onOff: true }, component: EnergyEvseMode2.OnOffComponent })
  });
  ...
  EnergyEvseMode2.CompleteInstance = MutableCluster({
    ...
    attributes: {
      ...
      onMode: MutableCluster.AsConditional(EnergyEvseMode2.OnOffComponent.attributes.onMode, { mandatoryIf: [DEPONOFF] })
    },

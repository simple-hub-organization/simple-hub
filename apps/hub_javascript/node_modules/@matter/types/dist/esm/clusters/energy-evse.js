...
((EnergyEvse2) => {
  ...
  EnergyEvse2.TlvChargingTargetSchedule = TlvObject({
    dayOfWeekForSequence: TlvOptionalField(0, TlvBitmap(TlvUInt8, EnergyEvse2.TargetDayOfWeek)),
    chargingTargets: TlvOptionalField(1, TlvArray(EnergyEvse2.TlvChargingTarget, { maxLength: 10 }))
  });

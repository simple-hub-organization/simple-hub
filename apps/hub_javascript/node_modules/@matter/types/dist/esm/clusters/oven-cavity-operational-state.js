...
((OvenCavityOperationalState2) => {
  OvenCavityOperationalState2.ClusterInstance = MutableCluster({
    ...
    attributes: {
       ...
       */
      operationalError: Attribute(5, OperationalState.TlvErrorState)
    },
    commands: {
      /**
       ...
       */
      pause: OptionalCommand(0, TlvNoArguments, 0, TlvNoResponse),
      /**
       ...
       */
      stop: OptionalCommand(1, TlvNoArguments, 1, TlvNoResponse),
      /**
       ...
       */
      start: OptionalCommand(2, TlvNoArguments, 2, TlvNoResponse),
      /**
       ...
       */
      resume: OptionalCommand(3, TlvNoArguments, 3, TlvNoResponse)
    },
    events: {
      /**

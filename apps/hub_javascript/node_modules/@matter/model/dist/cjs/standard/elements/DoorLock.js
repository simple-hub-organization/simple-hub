...
const DoorLock = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Normal", constraint: "0", description: "Normal operation mode" }),
    (0, import_elements.FieldElement)({ name: "Vacation", constraint: "1", description: "Vacation operation mode" }),
    (0, import_elements.FieldElement)({ name: "Privacy", constraint: "2", description: "Privacy operation mode" }),
    (0, import_elements.FieldElement)({ name: "NoRemoteLockUnlock", constraint: "3", description: "No remote lock and unlock operation mode" }),
    (0, import_elements.FieldElement)({ name: "Passage", constraint: "4", description: "Passage operation mode" })
  ),
  (0, import_elements.DatatypeElement)(

...
const DeviceEnergyManagement = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)(
    ...
    (0, import_elements.FieldElement)({
      name: "PFR",
      conformance: "(STA | PAU | FA | CON) & !SFR, O.a+",
      constraint: "1",
    ...
    (0, import_elements.FieldElement)({
      name: "SFR",
      conformance: "(STA | PAU | FA | CON) & !PFR, O.a+",
      constraint: "2",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Offline", id: 1, conformance: "O", description: "The ESA was set to offline" }),
    (0, import_elements.FieldElement)({
      name: "Fault",
      id: 2,
      conformance: "O",
    ...
    (0, import_elements.FieldElement)({ name: "Cancelled", id: 4, conformance: "O", description: "The adjustment was cancelled by a client" })
  ),
  (0, import_elements.DatatypeElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "GridOptimization", id: 2, conformance: "O", description: "The update was due to grid optimization" })
  ),
  (0, import_elements.DatatypeElement)(
    {
      name: "CostStruct",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "SlotIsPauseable", id: 5, type: "bool", conformance: "PAU" }),
    (0, import_elements.FieldElement)({
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({
      ...
      conformance: "M",
      constraint: "desc",
      details: "This field shall indicate the new requested power that the ESA shall operate at. It MUST be between the MinPowerAdjustment and MaxPowerAdjustment for the slot as advertised by the ESA.",

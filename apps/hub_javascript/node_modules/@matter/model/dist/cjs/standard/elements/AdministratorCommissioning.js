...
const AdministratorCommissioning = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.CommandElement)(
    ...
    (0, import_elements.FieldElement)({
      ...
      details: "This field shall be used by the Node as the PAKE iteration count associated with the ephemeral PAKE passcode verifier to be used for this commissioning, which shall be sent by the Node to the new Administrator\u2019s software as response to the PBKDFParamRequest during PASE negotiation.\nThe permitted range of values shall match the range specified in Section 3.9, \u201CPassword-Based Key Derivation Function (PBKDF)\u201D, within the definition of the Crypto_PBKDFParameterSet.",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Busy", id: 2, description: "Could not be completed because another commissioning is in progress" }),
    (0, import_elements.FieldElement)({
      name: "PakeParameterError",
      id: 3,
      description: "Provided PAKE parameters were incorrectly formatted or otherwise invalid"
    }),
    (0, import_elements.FieldElement)({ name: "WindowNotOpen", id: 4, description: "No commissioning window was currently open" })
  )
);

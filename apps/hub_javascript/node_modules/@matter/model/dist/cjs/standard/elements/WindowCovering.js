...
const WindowCovering = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.CommandElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Ignored", id: 1, type: "percent100ths", conformance: "X", constraint: "desc" })
  ),
  (0, import_elements.CommandElement)(
    {
      name: "GoToTiltValue",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "OnlineReserved", constraint: "1", description: "Deprecated and reserved." }),
    (0, import_elements.FieldElement)(
      {

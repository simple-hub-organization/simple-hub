...
const TimeSynchronization = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)({
    ...
    default: null,
    quality: "X N",
    details: "A Node ID, endpoint, and associated fabric index of a Node that may be used as trusted time source. See Time source prioritization. This attribute reflects the last value set by an administrator using the SetTrustedTimeSource command. If the value is null, no trusted time source has yet been set.",
  ...
  (0, import_elements.CommandElement)(
    ...
    (0, import_elements.FieldElement)({
      ...
      conformance: "M",
      default: 0,
      details: "This shall give the Client\u2019s Granularity, as described in Section 11.17.8.2, \u201CGranularity Attribute\u201D.",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "TimeNotAccepted", id: 2, description: "Node rejected the attempt to set the UTC time" })
  )
);

...
const ContentControl = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)({
    ...
    access: "R V",
    conformance: "BU",
    details: "Indicates whether the playback of unrated content is allowed when the Content Control feature is activated. If this attribute equals FALSE, then playback of unrated content\nshall be permitted. Otherwise, the media device shall prevent the playback of unrated content.\nWhen this attribute changes, the device SHOULD make the user aware of any limits of this feature. For example, if the feature does not control content within apps, then the device should make this clear to the user when the attribute changes.",
  ...
  (0, import_elements.CommandElement)(
    ...
    (0, import_elements.FieldElement)({
      ...
      conformance: "M",
      constraint: "max 8",
      details: "This field indicates a threshold rating for filtering scheduled content. This field shall be set to one\nof the values present in the ScheduledContentRatings attribute.",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Sunday", id: 0, description: "Sunday" }),
    (0, import_elements.FieldElement)({ name: "Monday", id: 1, description: "Monday" }),
    (0, import_elements.FieldElement)({ name: "Tuesday", id: 2, description: "Tuesday" }),
    (0, import_elements.FieldElement)({ name: "Wednesday", id: 3, description: "Wednesday" }),
    (0, import_elements.FieldElement)({ name: "Thursday", id: 4, description: "Thursday" }),
    (0, import_elements.FieldElement)({ name: "Friday", id: 5, description: "Friday" }),
    (0, import_elements.FieldElement)({ name: "Saturday", id: 6, description: "Saturday" })
  ),
  (0, import_elements.DatatypeElement)(

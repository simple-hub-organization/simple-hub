...
export declare class Conformance extends Aspect<Conformance.Definition> {
    ...
    validateReferences(errorTarget: Conformance.ErrorTarget, lookup: Conformance.ReferenceResolver<boolean>): void;
    /**
     ...
     */
    isApplicable(features: Iterable<string>, supportedFeatures: Iterable<string>): boolean;
    toString(): string;
...
export declare namespace Conformance {
    ...
    function validateReferences(conformance: Conformance, ast: Ast, errorTarget: ErrorTarget, resolver: ReferenceResolver<boolean>): void;

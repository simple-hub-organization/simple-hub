...
class Conformance extends import_Aspect.Aspect {
   ...
   */
  isApplicable(features, supportedFeatures) {
    ...
    switch (ast2.type) {
      case "name" /* Name */:
        if (features.has(ast2.param)) {
          return supportedFeatures.has(ast2.param);
        }
        break;
      case "!" /* NOT */:
        const subvalue = processNode(ast2.param);
        if (typeof subvalue === "boolean") {
          return !subvalue;
        }
        break;
      case "&" /* AND */:
        if (!processNode(ast2.param.lhs) || !processNode(ast2.param.rhs)) {
          return false;
        }
        break;
      case "|" /* OR */:

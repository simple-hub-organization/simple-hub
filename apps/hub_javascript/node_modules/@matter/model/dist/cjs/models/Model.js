...
class Model {
  ...
  static create(definition) {
    if (typeof definition !== "object") {
      throw new import_general.InternalError(`Model definition must be object, not ${typeof definition}`);
    }
    const t = definition["tag"];
    const constructor = Model.types[t];
    if (!constructor) {
      throw new import_general.InternalError(`Unknown element tag "${t}"`);
    }

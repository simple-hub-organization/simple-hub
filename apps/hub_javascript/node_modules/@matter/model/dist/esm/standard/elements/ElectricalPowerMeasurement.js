...
const ElectricalPowerMeasurement = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Dc", id: 1, conformance: "M", description: "Direct current" }),
    Field({ name: "Ac", id: 2, conformance: "M", description: "Alternating current, either single-phase or polyphase" })
  ),
  Datatype(
    {

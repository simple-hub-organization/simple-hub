...
const NetworkCommissioning = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "2G4", id: 0, conformance: "O.a+", description: "2.4GHz - 2.401GHz to2.495GHz(802.11b/g/n/ax)" }),
    Field({ name: "3G65", id: 1, conformance: "O.a+", description: "3.65GHz - 3.655GHz to3.695GHz (802.11y)" }),
    Field({ name: "5G", id: 2, conformance: "O.a+", description: "5GHz - 5.150GHz to5.895GHz(802.11a/n/ac/ax)" }),
    Field({ name: "6G", id: 3, conformance: "O.a+", description: "6GHz - 5.925GHz to7.125GHz (802.11ax / Wi-Fi 6E)" }),
    Field({ name: "60G", id: 4, conformance: "O.a+", description: "60GHz - 57.24GHz to70.20GHz (802.11ad/ay)" }),
    Field({ name: "1G", id: 5, conformance: "O.a+", description: "Sub-1GHz - 755MHz to 931MHz (802.11ah)" })
  ),
  Datatype(
    { name: "NetworkCommissioningStatusEnum", type: "enum8", xref: { document: "core", section: "11.9.5.4" } },
    Field({ name: "Success", id: 0, description: "OK, no error" }),
    Field({ name: "OutOfRange", id: 1, description: "Value Outside Range" }),
    Field({ name: "BoundsExceeded", id: 2, description: "A collection would exceed its size limit" }),
    Field({
    ...
    Field({ name: "NetworkNotFound", id: 5, description: "Cannot find AP: SSID Not found" }),
    Field({
      name: "RegulatoryError",
      id: 6,
      description: "Cannot find AP: Mismatch on band/channels/regulatory domain / 2.4GHz vs 5GHz"
    }),
    Field({ name: "AuthFailure", id: 7, description: "Cannot associate due to authentication failure" }),
    Field({ name: "UnsupportedSecurity", id: 8, description: "Cannot associate due to unsupported security mode" }),
    Field({ name: "OtherConnectionFailure", id: 9, description: "Other association failure" }),
    Field({ name: "Ipv6Failed", id: 10, description: "Failure to generate an IPv6 address" }),
    Field({ name: "IpBindFailed", id: 11, description: "Failure to bind Wi-Fi <-> IP interfaces" }),
    Field({ name: "UnknownError", id: 12, description: "Unknown error" })
  ),
  Datatype(
    {
  ...
  Datatype(
    ...
    Field({ name: "PanId", id: 0, type: "uint16", conformance: "TH", constraint: "0 to 65534" }),

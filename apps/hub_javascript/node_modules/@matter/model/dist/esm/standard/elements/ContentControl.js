...
const ContentControl = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Sunday", id: 0, description: "Sunday" }),
    Field({ name: "Monday", id: 1, description: "Monday" }),
    Field({ name: "Tuesday", id: 2, description: "Tuesday" }),
    Field({ name: "Wednesday", id: 3, description: "Wednesday" }),
    Field({ name: "Thursday", id: 4, description: "Thursday" }),
    Field({ name: "Friday", id: 5, description: "Friday" }),
    Field({ name: "Saturday", id: 6, description: "Saturday" })
  ),
  Datatype(

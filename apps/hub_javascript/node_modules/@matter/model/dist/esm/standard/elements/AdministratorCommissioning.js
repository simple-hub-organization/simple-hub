...
const AdministratorCommissioning = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Busy", id: 2, description: "Could not be completed because another commissioning is in progress" }),
    Field({
      name: "PakeParameterError",
      id: 3,
      description: "Provided PAKE parameters were incorrectly formatted or otherwise invalid"
    }),
    Field({ name: "WindowNotOpen", id: 4, description: "No commissioning window was currently open" })
  )
);

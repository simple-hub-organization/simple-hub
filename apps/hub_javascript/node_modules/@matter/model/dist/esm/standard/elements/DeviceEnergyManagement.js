...
const DeviceEnergyManagement = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Offline", id: 1, conformance: "O", description: "The ESA was set to offline" }),
    Field({
      name: "Fault",
      id: 2,
      conformance: "O",
    ...
    Field({ name: "Cancelled", id: 4, conformance: "O", description: "The adjustment was cancelled by a client" })
  ),
  Datatype(
  ...
  Datatype(
    ...
    Field({ name: "GridOptimization", id: 2, conformance: "O", description: "The update was due to grid optimization" })
  ),
  Datatype(
    {
      name: "CostStruct",
  ...
  Datatype(
    ...
    Field({ name: "SlotIsPauseable", id: 5, type: "bool", conformance: "PAU" }),
    Field({

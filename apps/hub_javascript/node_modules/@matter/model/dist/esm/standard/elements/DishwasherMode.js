...
const DishwasherMode = Cluster(
  {
    ...
    pics: "DISHM",
    details: "This cluster is derived from the Mode Base cluster, defining additional mode tags and namespaced enumerated values for dishwasher devices.",
    xref: { document: "cluster", section: "8.3" }
  },
  Attribute({ name: "ClusterRevision", id: 65533, type: "ClusterRevision", default: 2 }),
  Attribute({ name: "SupportedModes", id: 0, conformance: "M", xref: { document: "cluster", section: "8.3.5" } }),
  Attribute({ name: "CurrentMode", id: 1, conformance: "M", xref: { document: "cluster", section: "8.3.5" } }),
  Attribute({
    name: "StartUpMode",
    id: 2,
    conformance: "P",
  ...
  Attribute({ name: "OnMode", id: 3, conformance: "P", xref: { document: "cluster", section: "8.3.5" } }),
  Datatype({
...
//# sourceMappingURL=DishwasherMode.js.map

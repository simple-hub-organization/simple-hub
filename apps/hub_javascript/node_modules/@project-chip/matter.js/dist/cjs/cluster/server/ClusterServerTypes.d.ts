...
import { AnyEventServer, AttributeServer, ClusterClientObj, CommandServer, Fabric, FabricScopedAttributeServer, FixedAttributeServer, Message, Session } from "#protocol";
import { Attribute, AttributeId, AttributeJsType, Attributes, Cluster, ClusterId, ClusterType, Command, CommandId, Commands, EventId, Events, EventType, FabricScopedAttribute, FixedAttribute, GlobalAttributes, MandatoryAttributeNames, MandatoryEventNames, OptionalAttribute, OptionalAttributeNames, OptionalCommand, OptionalEventNames, OptionalFixedAttribute, OptionalWritableAttribute, OptionalWritableFabricScopedAttribute, RequestType, ResponseType, WritableAttribute, WritableFabricScopedAttribute } from "#types";
...
export type AttributeServers<A extends Attributes = Attributes> = Merge<MandatoryAttributeServers<A>, OptionalAttributeServers<A>>;
...
export type ClusterServerHandlers<C extends ClusterType> = Merge<CommandHandlers<C["commands"], AttributeServers<C["attributes"]>, EventServers<C["events"]>>, Merge<AttributeHandlers<C["attributes"]>, {
...
export type UseOptionalAttributes<C extends Cluster<any, any, any, any, any>, A extends OptionalAttributeConf<C["attributes"]>> = Cluster<C["features"], C["supportedFeatures"], MakeAttributesMandatory<C["attributes"], A>, C["commands"], C["events"]>;
...
export declare function isClusterServer<T extends ClusterType>(obj: ClusterClientObj<T> | ClusterServerObj<T>): obj is ClusterServerObj<T>;
export declare function isClusterServerInternal<T extends ClusterType>(obj: ClusterClientObj<T> | ClusterServerObj<T>): obj is ClusterServerObjInternal<T>;
export declare function asClusterServerInternal<T extends ClusterType>(obj: ClusterServerObj<T>): ClusterServerObjInternal<T>;
export {};
